...
const INCIDENTS = [
  {
    ...
    type: 'Product Tanker',
    flag: 'Malta',
    event: 'Interdicted by IRGC at 26.4°N 56.1°E. Crew of 22 detained at Bandar Abbas. Vessel impounded. Triggered collapse of Apr 8 ceasefire.',
  ...
  {
    date: '2026-04-05',
    vessel: 'AURORA SPIRIT',
    type: 'Chemical Tanker',
    flag: 'Marshall Islands',
    event: 'Engine room fire following near-miss with IRGC speedboat at 26.4°N 56.3°E. Vessel underway; structural assessment pending.',
    severity: 'HIGH' as const,
    simulated: true,
  },
  {
    date: '2026-03-28',
    vessel: 'GULF ENTERPRISE',
    type: 'Bulk Carrier',
    flag: 'Singapore',
    event: 'Transit aborted following IRGC radio warning. Owner rerouting via Cape of Good Hope (+19 days).',
    severity: 'LOW' as const,
    simulated: true,
  },
  {
    date: '2026-03-01',
    vessel: 'DAWN MERCHANT',
    type: 'Container Feeder',
    flag: 'Panama',
    event: 'Approached by IRGC naval vessel on first day of blockade. Master ordered to anchorage off Khasab, Oman. Crew safe; cargo intact.',
    severity: 'MODERATE' as const,
    simulated: true,
  },
];
